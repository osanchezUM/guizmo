 ...
 * <ul>
 *   <li>{@link lasser.sketch.impl.TableImpl#getRows <em>Rows</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableImpl extends WidgetImpl implements Table {
	...
	protected EClass eStaticClass() {
		return SketchPackage.Literals.TABLE;
	}
	...
	public EList<Row> getRows() {
		if (rows == null) {
			rows = new EObjectContainmentEList<Row>(Row.class, this, SketchPackage.TABLE__ROWS);
		}
		return rows;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SketchPackage.TABLE__ROWS:
