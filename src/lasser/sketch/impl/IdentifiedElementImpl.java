 ...
 * <ul>
 *   <li>{@link lasser.sketch.impl.IdentifiedElementImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class IdentifiedElementImpl extends EObjectImpl implements IdentifiedElement {
	...
	protected EClass eStaticClass() {
		return SketchPackage.Literals.IDENTIFIED_ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SketchPackage.IDENTIFIED_ELEMENT__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SketchPackage.IDENTIFIED_ELEMENT__ID:
				return getId();
		}
