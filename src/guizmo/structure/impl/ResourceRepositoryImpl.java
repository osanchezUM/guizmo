 ...
 * <ul>
 *   <li>{@link guizmo.structure.impl.ResourceRepositoryImpl#getResources <em>Resources</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceRepositoryImpl extends EObjectImpl implements ResourceRepository {
	...
	protected EClass eStaticClass() {
		return StructurePackage.Literals.RESOURCE_REPOSITORY;
	}
	...
	public EList<Resource> getResources() {
		if (resources == null) {
			resources = new EObjectContainmentEList<Resource>(Resource.class, this, StructurePackage.RESOURCE_REPOSITORY__RESOURCES);
		}
		return resources;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructurePackage.RESOURCE_REPOSITORY__RESOURCES:
